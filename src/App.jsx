    ...
    <main className="py-20 px-6 min-h-svh bg-offwhitebg">
      <section>
        <div className="bg-laranja p-12 rounded-t-lg">
          ...
          <p className="font-deca  mb-7">Escolha um sedan pelo seu preço acessível e excelente economia de combustível. Ideal para dirigir na cidade ou na sua próxima viagem.</p>
        ...
        <div className="bg-verde p-12">
          ...
          <p className="font-deca mb-7">Escolha um SUV pelo seu interior espaçoso, poder e versatilidade. Perfeito para passar as férias em família ou para aventuras off-road.</p>
        ...
        <div className="bg-verde-escuro p-12 rounded-b-lg">
          ...
          <p className="font-deca mb-7">Passeie nos melhores carros sem os preços exorbitantes. Desfrute do conforto aprimorado de um aluguel de luxo e chegue com estilo.</p>
